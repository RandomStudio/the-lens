...
fn main() {
    ...
    if cfg.is_debug_screen {
        ...
        let mut disp = DebugDisplay::new(&cfg.sequence_path, transform, cfg.min_scale, cfg.max_scale, cfg.brightest_brightness, cfg.easing_multiplier);
        while disp.is_open() {
        ...
        let mut disp = Display::new(&cfg.sequence_path, &cfg.diamond_path, transform, cfg.min_scale, cfg.max_scale, cfg.brightest_brightness, cfg.easing_multiplier);
        while disp.is_open() {
            let angle = receiver.angle();
